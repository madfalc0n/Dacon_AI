...
simulator = Simulator()
submission_ini = pd.read_csv('/gdrive/My Drive/Colab Notebooks/DACON/LG_factory_toy_system/baseline/module/sample_submission.csv')
order_ini = pd.read_csv('/gdrive/My Drive/Colab Notebooks/DACON/LG_factory_toy_system/baseline/module/order.csv')
