...
import sys
sys.path.append('/gdrive/My Drive/Colab Notebooks/DACON/LG_factory_toy_system/baseline/module')
...
class Simulator:
    def __init__(self):
        ...
        self.sample_submission = pd.read_csv('/gdrive/My Drive/Colab Notebooks/DACON/LG_factory_toy_system/baseline/module/sample_submission.csv')
        self.max_count = pd.read_csv('/gdrive/My Drive/Colab Notebooks/DACON/LG_factory_toy_system/baseline/module/max_count.csv')
        self.stock = pd.read_csv('/gdrive/My Drive/Colab Notebooks/DACON/LG_factory_toy_system/baseline/module/stock.csv')
        self.order = pd.read_csv('/gdrive/My Drive/Colab Notebooks/DACON/LG_factory_toy_system/baseline/module/order.csv')
